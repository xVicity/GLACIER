...
closeButton.TouchTap:Once(function()
    shamanScreenGui:Destroy()
    tooltipScreenGui:Destroy()
end)
...
editButton.TouchTap:Connect(function()
    editclicked()
end)
...
dropdownContainerTextButton.TouchTap:Connect(function()
    dropdownclicked()
end)
end
...
radioTextButton.TouchTap:Connect(function()
    task.spawn(function()
        pcall(Info.Callback, radioText.Text)
    end)
    if Info.Flag ~= nil then
...
radioButtonTextButton.TouchTap:Connect(function()
    RadioOpened = not RadioOpened
...
tabTextButton.MouseButton1Click:Connect(function()
	...
	tabTextButton.TouchTap:Connect(function()
		TabSelected = tabFrame
		task.spawn(function()
		for _,v in pairs(main:GetChildren()) do
			if v.Name == "LeftContainer" or v.Name == "RightContainer" then
